			...
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li>
						...
						<ul>
							<a href="/Brim/logo/logo.php">Logo</a>
						</ul>
					...
					<li>
						...
						<ul>
							<a href="/Brim/banner/banner.php">Banner</a>
							<a href="/Brim/banner/banner_image.php">Image</a>
							<a href="/Brim/social/social.php">social</a>
						</ul>
